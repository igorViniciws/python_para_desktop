...
class FormularioInscricao:
    def __init__(self, master):
        ...
        self.temas = [
            "darkly", "flatly", "litera", "minty", "lumen", "sandstone",
        ...
        self.lembrar_check = ttk.Checkbutton(
            self.opcoes_frame,
            text="Lembrar dados?",
    ...
    def enviar(self):
        ...
        self.lembrar_label.config(
            text=f"Lembrar dados: {'Sim' if self.lembrar_var.get() else 'Não'}"
        )
